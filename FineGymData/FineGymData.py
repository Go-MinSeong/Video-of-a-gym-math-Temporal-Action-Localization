...
def download_data(json_dir, out_dir, label_dir):
    no_download=[]
    #dict_title ={}
    ...
    for obj_url in tqdm(data_obj_list):
        ...
        yt = YouTube(url)
        try:
            fc = yt.streams.filter(file_extension='mp4', res="360p").first()
...
# label file download
def main(json_dir, vidoe_dir, label_dir):
    url_lst = []
    url_lst.extend(['https://sdolivia.github.io/FineGym/resources/dataset/finegym_annotation_info_v1.0.json',
               'https://sdolivia.github.io/FineGym/resources/dataset/gym99_train_element_v1.0.txt',
    ...
    download_data(json_dir, vidoe_dir, label_dir)


if __name__ == "__main__":
  main( 
'/home/work/golf/FineGymData/label/finegym_annotation_info_v1.0.json',
 '/home/work/golf/FineGymData/movie',
 '/home/work/golf/FineGymData/label')